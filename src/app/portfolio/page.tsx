...
const testimonials = [
  {
    ...
    text: "Denara Creative membantu kami membuat brand identity yang kuat. Setelah rebranding, penjualan meningkat 150%!",
    rating: 5
  },
  {
    name: "Budi Hartono",
    business: "Konveksi Budi Jaya",
    text: "Website toko online yang dibuat sangat user-friendly. Sekarang kami bisa menjual ke seluruh Indonesia.",
    rating: 5
  },
  {
    name: "Maya Sari",
    business: "Kue Maya Homemade",
    text: "Tim fotografi produk mereka luar biasa! Foto-foto kue kami jadi terlihat sangat menggugah selera.",
    rating: 5
  }
];
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Testimoni dari UMKM yang telah merasakan dampak positif dari layanan kami
            </p>
          </div>
