...
const Footer = () => {
  ...
  const services = [
    { name: 'Branding & Desain', href: '/services#branding' },
    { name: 'Website & Toko Online', href: '/services#website' },
    { name: 'Social Media Management', href: '/services#social-media' },
    { name: 'Fotografi & Videografi', href: '/services#photography' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <div className="mt-4">
              <a
                ...
                className="inline-flex items-center space-x-2 bg-[#9B1B60] text-white px-4 py-2 rounded-lg hover:bg-[#7a1549] transition-colors duration-200"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Denara Creative Digital. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
